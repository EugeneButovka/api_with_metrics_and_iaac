...
module "eks" {
  ource = "https://github.com/terraform-aws-modules/terraform-aws-eks.git?ref=v20.5.0"
...
module "eks_managed_node_group" {
  source = "https://github.com/terraform-aws-modules/terraform-aws-eks.git//modules/eks-managed-node-group?ref=v20.5.0"
